...
const Component: React.FC<{id:number, player: userTableDisplay[], createPortal: () => void, difficulty: string, onHover:boolean, personalData : userTableDisplay | null}> = ({id, player, createPortal, difficulty, onHover, personalData}) => {
 ...
 { difficulty === "easy" ? <IoIosCode/> : difficulty === "medium" ? <IoMdCodeWorking/> : <BsFileEarmarkCodeFill/> }
 </div>
